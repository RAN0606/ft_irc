...
/*   Updated: 2023/04/11 17:24:44 by rliu             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
# include "Client.hpp"
	...
	class Replies {
		...
		public :
			...
			/* "433" */ std::string ERR_NICKNAMEINUSE(std::string nick, std::string reason) { return (":" + this->_prefix + " 433 " + this->_nickname + " " + nick+ " :" + reason + + "\r\n"); };
